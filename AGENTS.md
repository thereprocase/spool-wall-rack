...
Print assumptions: 0.2 mm layers; 1.2 mm top and bottom; 15% infill gets zero structural credit. E1 proposes 2.4 mm modeled structural perimeter, superseding the original three-perimeter assumption locally; verify actual sliced paths. Internal and exterior side plates remain 1.2 mm. Snap fingers are separately dimensioned.
