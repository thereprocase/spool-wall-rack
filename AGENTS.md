...
Snap roots must transition smoothly into the bearing seat. Do not use intersecting circles over a stepped profile as a substitute for tangent root blends. Round relief-slot ends and inspect the actual integrated bracket profile, not just an isolated retainer. Current reference is E7.
