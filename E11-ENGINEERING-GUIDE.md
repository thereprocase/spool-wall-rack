# Archived E11 engineering guide

Historical 38 mm reinforcement; E12 supersedes this shape and its current-status claims.
For the current prototype use [README](README.md).
