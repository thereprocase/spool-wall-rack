"""Checked E13 3D results, current material scaling, and bounded creep cases."""
...
def main():
 ...
 for n in [8,10]:
  coarse_h=1.5
  a=read(f'print-material-{n}w-h{coarse_h}');b=read(f'print-material-{n}w-h1')
 ...
 fig.suptitle('E13 material planning / creep evidence and its limits',fontsize=15)
 fig.supxlabel('A finite fitted spectrum plateaus by construction. These curves are not service-life predictions.\nE13 movement scenarios use the newly solved E13 geometry coefficients.',fontsize=9)
 ...
 text='''# E13 solved engineering results
