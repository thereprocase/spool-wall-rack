"""Checked E11 3D results, current material scaling, and bounded creep cases."""
...
def main():
 ...
 for n in [8,10]:
  a=read(f'print-material-{n}w-h3');b=read(f'print-material-{n}w-h2')
 ...
 summary['numerical_rejections']=[{'case':'Initial 10-wall coarse mesh','reason':'Free residual 3.17e-4 exceeded 1e-6; field rejected and remeshed after same-domain CAD face cleanup.'},{'case':'Initial 8-wall refined topology','reason':'335 MPa raw peak in a 3.10e-10 mm3 tunnel-mouth sliver; remeshed after same-domain face cleanup. Front movement changed 0.13%.'}]
 ...
 fig.suptitle('E11 material planning / creep evidence and its limits',fontsize=15)
 fig.supxlabel('A finite fitted spectrum plateaus by construction. These curves are not service-life predictions.\nE11 movement scenarios use the newly solved E11 geometry coefficients.',fontsize=9)
 ...
 text='''# E11 solved engineering results
