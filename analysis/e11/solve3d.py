"""E11 small-strain isotropic 3D FEM, constant-strain tetrahedra.
...
if contact and not coarse.exists() and name.startswith('print-material-10w'):
 coarse=D/'print-material-8w-h3-solution.npz'
if contact and coarse.exists() and coarse.name!=name+'-solution.npz':
