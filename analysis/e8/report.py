...
def render2(name):
 ...
 fig.suptitle('E8 level rails • 8 walls • 12 kg equivalent per bracket',fontsize=16,fontweight='bold')
...
def raised_front():
 ...
 fig.supxlabel('Two frictionless contacts. Concept geometry only: no revised bracket, snap-clearance check or raised-front FEM yet.',fontsize=9)
