...
def render(name,parts,title,subtitle,view=(19,-59),lim=None,dims=None):
 ...
 draw.text((90,H-70),'REV E13 · ACTUAL FINISHED CAD · GEOMETRY PROTOTYPE',font=ImageFont.truetype(fonts+'DejaVuSans.ttf',17),fill='#667779')
 im.save(D/name)

if __name__=='__main__':
 body=read_stl('body-mounted.stl')
 render('progress-exterior.png',[(body,(.23,.52,.54))],
  'E13 / ANGULAR INNER SEAT',
  '11 mm added depth · straight underside tapers · mirrored 50° chamfers',view=(17,-57))
