...
def main():
 ...
 machine={**common,'type':'machine','name':'E13 geometry audit 256mm',
  'printer_settings_id':'E13 geometry audit 256mm','printer_technology':'FFF',
 ...
 process={**common,'type':'process','name':f'E13 {walls} wall structural audit',
  'print_settings_id':f'E13 {walls} wall structural audit','compatible_printers':[machine['name']],
 ...
 assembly={'plates':[{'plate_name':f'E13 {walls} wall audit','need_arrange':True,
