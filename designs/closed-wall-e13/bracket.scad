// Revision E13: solid exterior profile with load-aligned snaps.
...
front_lift=12;
// Straight reinforcement facets, with the existing small corner finish.
// Eleven millimetres added depth stays below the 38/3 mm absolute cap.
// Long flanks carry the thickening into the knee and outer arm without steps.
seat_extra_depth=11;
profile_points=[[0,176],[0,-32],[35,-32],[76,-32-seat_extra_depth],
 [104,-32-seat_extra_depth],[145,-32],[190,-32],[190,7.2],
 [110,-2.4],[66,6],[30,48],[17.5,82],[12,108],[12,128],[18,176]];
...
module arm_outline(){
 difference(){
  offset(r=2) offset(r=-2) offset(r=-2) offset(r=2) union(){
   ...
   // E13 removes the obsolete projecting lower screw-head pad.
...
if(part=="bracket")assert(false,"Build the finished E13 solid with build_step.py");
