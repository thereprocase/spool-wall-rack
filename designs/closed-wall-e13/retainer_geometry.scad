...
// Reference spool tangent to the nominal rail centers; include seat clearance in fit sweep.
snap_rail_lift=12;
snap_spacing=sqrt(100*100+snap_rail_lift*snap_rail_lift);
snap_q=sqrt(pow(reference_spool_d/2+snap_rod_r-snap_radial_clearance,2)-snap_spacing*snap_spacing/4);
snap_cx=140-snap_rail_lift*snap_q/snap_spacing;
snap_cy=snap_rail_lift/2+100*snap_q/snap_spacing;
rear_rotation=atan2(snap_cy,snap_cx-90)-90;
front_rotation=atan2(snap_cy-snap_rail_lift,snap_cx-190)-90;
...
module front_collar(){rotate(front_rotation)collar();}
