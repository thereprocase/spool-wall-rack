// Revision E5: angular profile, load-aligned snaps, 2.4 mm perimeter.
// Run finish_cad.py for final chamfers and matching cavity reinforcement.
...
wall_bottom=-44; wall_top=150;
profile_points=[[0,150],[0,-44],[226,-44],[226,-26],[92,-26],[66,-13],[24,114],[20,150]];
...
module arm_outline(){
 difference(){
  offset(r=2) offset(r=-2) offset(r=-2) offset(r=2) union(){
   ...
   polygon([[40,0],[50,-8],[60,0],[60,26],[54,32],[44,32],[40,26]]);
...
// Broad-face chamfers are applied by finish_cad.py using the exact profile.
if(part=="cavity_profile")hollow_profile();
