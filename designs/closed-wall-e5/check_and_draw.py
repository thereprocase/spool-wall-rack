...
report={'revision':'E5','status':'geometry prototype; no slicing, snap-force, fatigue, or strength validation',
...
fig.suptitle('E5 • ANGULAR FRAME / 3 mm FACE CHAMFERS',x=.055,ha='left',fontsize=21,fontweight='bold',color='#233e45')
