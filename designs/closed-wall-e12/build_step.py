"""Build E12 solid CAD body and aligned modifier slabs; no infill modeled.
...
if __name__=='__main__':
 ...
 assembly=cq.Assembly(name='E12_BODY_AND_MODIFIER_HELPERS')
 ...
 (D/'build-verification.json').write_text(json.dumps({
  'revision':'E12','valid_body':delivered.isValid(),'body_validation':'Reimported delivered body-only.step', 'body_solid_count':len(delivered.Solids()),
  ...
  'body_angular_fillet_mm':2,'rear_rigid_shoulder_blend_mm':6,'rear_underside_added_depth_mm':9.5,
 ...
 print('E12 body and modifier STEP exported',flush=True)
