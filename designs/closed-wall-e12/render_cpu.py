...
def render(name,parts,title,subtitle,view=(19,-59),lim=None,dims=None):
 ...
 draw.text((90,H-70),'REV E12 · ACTUAL FINISHED CAD · GEOMETRY PROTOTYPE',font=ImageFont.truetype(fonts+'DejaVuSans.ttf',17),fill='#667779')
 im.save(D/name)
...
if __name__=='__main__':
 ...
 render('progress-exterior.png',[(body,(.23,.52,.54))],
  'E12 / SLIM INNER SEAT',
  '9.5 mm added depth · shallow underside blend · mirrored 50° chamfers',view=(17,-57))
