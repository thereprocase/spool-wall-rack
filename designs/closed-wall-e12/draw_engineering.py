"""E12 actual-outline drawing and STL cross-section of the finished chamfers."""
...
ax.annotate('28.5 mm section depth\n9.5 mm added below arm',xy=(90,-36),xytext=(2,-65),arrowprops={'arrowstyle':'->'},fontsize=10)
ax.annotate('Reshaped back arm\nclears 180–220 mm spools',xy=(12,120),xytext=(65,205),arrowprops={'arrowstyle':'->'},fontsize=10)
ax.set(xlim=(-8,240),ylim=(-95,240),aspect='equal',xlabel='Projection from wall (mm)',ylabel='Installed height (mm)',title='Actual E12 profile with nominal dowels and spool envelopes')
...
fig.suptitle('E12 / slim inner seat • 9.5 mm reinforcement • 50° face chamfers',fontsize=16,fontweight='bold');fig.supxlabel('Actual finished outline and section. Shaded bands locate the slicer-generated plates; the CAD body is a solid envelope.',fontsize=9)
