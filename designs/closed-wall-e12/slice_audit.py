...
def main():
 ...
 machine={**common,'type':'machine','name':'E12 geometry audit 256mm',
  'printer_settings_id':'E12 geometry audit 256mm','printer_technology':'FFF',
 ...
 process={**common,'type':'process','name':f'E12 {walls} wall structural audit',
  'print_settings_id':f'E12 {walls} wall structural audit','compatible_printers':[machine['name']],
 ...
 assembly={'plates':[{'plate_name':f'E12 {walls} wall audit','need_arrange':True,
