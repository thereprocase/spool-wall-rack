...
def render(name,parts,title,subtitle,view=(19,-59),lim=None,dims=None):
 ...
 draw.text((90,H-70),'REV E7 · ACTUAL FINISHED CAD · GEOMETRY PROTOTYPE',font=ImageFont.truetype(fonts+'DejaVuSans.ttf',17),fill='#667779')
 im.save(D/name)

body=read_stl('mounted.stl')
render('progress-exterior.png',[(body,(.23,.52,.54))],
 'E7 / PRINT COMPARTMENTS + RECESSED FIXINGS',
 '3.6 mm clamping lands · 5.2 mm clearance · 16 mm driver access',view=(17,-57))
print('Exterior rendered',flush=True)

cut=read_stl('cutaway.stl')
render('progress-cutaway.png',[(cut,(.23,.52,.54))],
 'E7 / INTERNAL BRIDGE COMPARTMENTS',
 'Actual CAD cut at print Z = 4.4 mm · continuous plates retained',view=(25,-65))
print('Cutaway rendered',flush=True)
