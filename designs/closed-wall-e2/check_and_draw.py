...
report={'revision':'E2','status':'geometry prototype; no slicing, snap-force, fatigue, or strength validation',
...
fig.suptitle('E2 • SMOOTH SNAP ROOTS',x=.055,ha='left',fontsize=21,fontweight='bold',color='#233e45')
