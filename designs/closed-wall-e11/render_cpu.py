...
def render(name,parts,title,subtitle,view=(19,-59),lim=None,dims=None):
 ...
 draw.text((90,H-70),'REV E11 · ACTUAL FINISHED CAD · GEOMETRY PROTOTYPE',font=ImageFont.truetype(fonts+'DejaVuSans.ttf',17),fill='#667779')
 im.save(D/name)

if __name__=='__main__':
 body=read_stl('body-mounted.stl')
 render('progress-exterior.png',[(body,(.23,.52,.54))],
  'E11 / REINFORCED INNER SEAT',
  '38 mm added depth · smooth shoulder and underside blends · mirrored 50° chamfers',view=(17,-57))
