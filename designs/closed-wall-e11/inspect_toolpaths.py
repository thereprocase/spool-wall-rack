 ...
 for walls in [8,10]:
  ...
  if walls==8:
   for ax,k in zip(axes.flat,[3,19,41,59,79,117]):
    ...
    ax.set(xlim=(55,125),ylim=(-73,22),aspect='equal',title=f'Layer {k+1} / Z={(k+1)*.2:.1f} mm',xlabel='Projection X (mm)',ylabel='Height Y (mm)')
 fig.suptitle('E11 actual OrcaSlicer paths / inner seat / 8 walls',fontsize=16)
