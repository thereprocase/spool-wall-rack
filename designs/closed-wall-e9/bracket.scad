// Revision E9: solid exterior profile with load-aligned snaps.
...
module arm_outline(){
 difference(){
  offset(r=2) offset(r=-2) offset(r=-2) offset(r=2) union(){
   ...
   // E9 removes the obsolete projecting lower screw-head pad.
...
if(part=="bracket")assert(false,"Build the finished E9 solid with build_step.py");
