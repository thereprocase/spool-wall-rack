...
report={'revision':'E1','status':'geometry prototype; no slicing, snap-force, fatigue, or strength validation',
 ...
 'wrap_deg':218,'seat_diameter_mm':26,'finger_bending_thickness_mm':1.35,'bearing_radial_thickness_mm':5,
...
ax.annotate('5 mm rigid bearing seat\n180° opposite contact',xy=bearing-2*n,xytext=(45,-26),arrowprops={'arrowstyle':'->','color':'#164a53'},fontsize=10)
for theta,label,pos in [(161,'1.35 mm flexible finger',(40,19)),(379,'Rounded retaining nose',(97,-14))]:
...
fig.suptitle('E1 • ROTATED SNAP RETAINERS',x=.055,ha='left',fontsize=21,fontweight='bold',color='#233e45')
