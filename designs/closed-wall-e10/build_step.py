"""Build E10 solid CAD body and aligned modifier slabs; no infill modeled.
...
if __name__=='__main__':
 ...
 assembly=cq.Assembly(name='E10_BODY_AND_MODIFIER_HELPERS')
 ...
 (D/'build-verification.json').write_text(json.dumps({
  'revision':'E10','valid_body':result.isValid(),'body_solid_count':len(result.Solids()),
 ...
 print('E10 body and modifier STEP exported',flush=True)
