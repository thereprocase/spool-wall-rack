// Revision E10: solid exterior profile with load-aligned snaps.
...
front_lift=12;
profile_points=[[0,176],[0,-32],[190,-32],[190,7.2],[110,-2.4],[66,6],[30,48],[17.5,82],[12,108],[12,128],[18,176]];
...
module arm_outline(){
 difference(){
  offset(r=2) offset(r=-2) offset(r=-2) offset(r=2) union(){
   ...
   // E10 removes the obsolete projecting lower screw-head pad.
...
if(part=="bracket")assert(false,"Build the finished E10 solid with build_step.py");
