"""E10 actual-outline drawing and STL cross-section of the finished chamfers."""
...
ax.set(xlim=(-8,240),ylim=(-57,240),aspect='equal',xlabel='Projection from wall (mm)',ylabel='Installed height (mm)',title='Actual E10 profile with nominal dowels and spool envelopes')
...
fig.suptitle('E10 / raised front rail • 2 mm face chamfers • R2 wall transitions',fontsize=17,fontweight='bold');fig.supxlabel('Outline and cross-section extracted from the generated design. Thin snap noses retain their smaller working radii.',fontsize=9)
