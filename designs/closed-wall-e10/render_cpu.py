...
def render(name,parts,title,subtitle,view=(19,-59),lim=None,dims=None):
 ...
 draw.text((90,H-70),'REV E10 · ACTUAL FINISHED CAD · GEOMETRY PROTOTYPE',font=ImageFont.truetype(fonts+'DejaVuSans.ttf',17),fill='#667779')
 im.save(D/name)

body=read_stl('body-mounted.stl')
render('progress-exterior.png',[(body,(.23,.52,.54))],
 'E10 / FRONT RAIL +12 MM',
 '2 mm mirrored chamfers · R2 body corners · full-height wall contact',view=(17,-57))
