...
def main():
    ...
    report={'slicer':'OrcaSlicer 2.4.2','parameters':params,'layer_count':120,'roundtrip_parts':alignment,
            ...
            'input_3MF_sha256':hashlib.sha256((D/'rev-f-model-and-modifiers.3mf').read_bytes()).hexdigest(),
    ...
    fig.suptitle(f'Rev F / actual OrcaSlicer paths / {walls} walls',fontsize=19,fontweight='bold',color='#243d43')
