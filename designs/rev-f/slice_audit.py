...
def main():
    ...
    process['name']=process['print_settings_id']=f"Rev F {params['walls']} wall neutral audit"
    ...
    args=[exe,'--datadir',str(data),'--orient','0','--arrange','0','--slice','0','--outputdir',str(out),
          ...
          str(D/'rev-f-model-and-modifiers.3mf')]
    ...
    print('Rev F real-modifier audit sliced',flush=True)
