...
def main():
    ...
    draw.text((70,48),'E + F / DEEP FRAME, BACKED SEAT ROOTS',font=ImageFont.truetype(str(fonts/'DejaVuSans-Bold.ttf'),31),fill='#243d43')
    draw.text((70,102),'Actual exported CAD body / G rod interfaces and moulding datum retained',font=ImageFont.truetype(str(fonts/'DejaVuSans.ttf'),21),fill='#667779')
