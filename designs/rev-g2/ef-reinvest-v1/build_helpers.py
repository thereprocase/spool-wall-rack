"""Retain the lean EF cut; add a separate local 100-percent transition helper."""
...
def main():
    ...
    patches=union_all([LineString(v['points_XY_mm']).buffer(v['radius_mm'],quad_segs=12) for v in params['local_reinforcement']])
