...
report={'revision':'E6','status':'geometry prototype; no slicing, snap-force, fatigue, or strength validation',
...
fig.suptitle('E6 • SHORTER SPAN / FULL-HEIGHT WALL CONTACT',x=.055,ha='left',fontsize=21,fontweight='bold',color='#233e45')
