...
def render(name,parts,title,subtitle,view=(19,-59),lim=None,dims=None):
 ...
 draw.text((90,H-70),'REV E6 · ACTUAL FINISHED CAD · GEOMETRY PROTOTYPE',font=ImageFont.truetype(fonts+'DejaVuSans.ttf',17),fill='#667779')
 im.save(D/name)

body=read_stl('mounted.stl')
render('progress-exterior.png',[(body,(.23,.52,.54))],
 'E6 / COMPACT CLOSED-WALL BRACKET',
 '100 mm rail spacing · 28 mm nominal arm depth · full-height wall contact',view=(17,-57))
