"""Build E8 solid CAD body and aligned modifier slabs; no infill modeled.
...
if __name__=='__main__':
 ...
 assembly=cq.Assembly(name='E8_BODY_AND_MODIFIER_HELPERS')
 ...
 (D/'build-verification.json').write_text(json.dumps({
  'revision':'E8','valid_body':result.isValid(),'body_solid_count':len(result.Solids()),
 ...
 print('E8 body and modifier STEP exported',flush=True)
