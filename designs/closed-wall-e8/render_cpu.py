...
def render(name,parts,title,subtitle,view=(19,-59),lim=None,dims=None):
 ...
 draw.text((90,H-70),'REV E8 · ACTUAL FINISHED CAD · GEOMETRY PROTOTYPE',font=ImageFont.truetype(fonts+'DejaVuSans.ttf',17),fill='#667779')
 im.save(D/name)

body=read_stl('body-mounted.stl')
render('progress-exterior.png',[(body,(.23,.52,.54))],
 'E8 / SOLID BODY + MODIFIER HELPERS',
 'Body walls and infill: user-selected · two 1.2 mm helper slabs',view=(17,-57))
